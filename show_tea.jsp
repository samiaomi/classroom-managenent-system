  ...
  <body>
        <%
            ...
            try {
                ...
                stmt.executeUpdate("Update allocate set teacher_name= '" + first + "',teachers_designation = '" + Sec + "' , dept_name  = '" + third + "' , course_code = '" + fourth + "' , contact_no = '" + day +  "',Email='"+ email +"' where teacher_id='" + classr + "'");
